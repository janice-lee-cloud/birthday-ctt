  ...
  return (
    <>
      ...
      <motion.button
        ...
        data-no-hearts
        onClick={toggle}
        className={`fixed bottom-6 right-4 z-[90] flex h-14 w-14 touch-manipulation items-center justify-center rounded-full border bg-white/10 text-white shadow-[0_0_30px_rgba(244,114,182,0.35)] backdrop-blur-xl transition-colors hover:bg-white/20 max-md:bottom-5 ${
